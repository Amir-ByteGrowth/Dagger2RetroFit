package com.example.daggerretrofit.adaptors;
...
import com.example.daggerretrofit.mode.Result;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;
import java.util.List;

public class UserAdapter extends RecyclerView.Adapter<UserAdapter.RandomUserViewHolder> {

    private final Picasso picasso;
    private List<Result> resultList = new ArrayList<>();


    public UserAdapter(Picasso picasso) {
